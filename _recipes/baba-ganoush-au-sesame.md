---
title: 'Baba ganoush au sésame'
slug: 'baba-ganoush-au-sesame'
sort_order: 6
hero_image: '/assets/images/recipes/baba_ganoush.jpg'
base_servings: 4
prep_time: '15 min'
cook_time: '30 min'
total_time: '45 min'
source_label: 'undejeunerdesoleil.com'
source_url: 'https://www.undejeunerdesoleil.com/2014/05/baba-ganoush-caviar-aubergines.html'
diet:
  vegan: 'inherent'
...
ingredients:
  - name: 'Aubergines'
    ...
    unit: ''
    optional: false
    notes: 'Moyennes, environ 600 g au total'
  - name: 'Pâte de sésame (tahini)'
    quantity: 1
    unit: 'cs'
    optional: false
    notes: 'Voir plus selon les goûts'
  - name: 'Jus de citron jaune'
    quantity: 1
    unit: ''
    optional: false
    notes: 'Fraîchement pressé'
  - name: 'Ail'
    quantity: 1
    unit: 'tête'
    optional: false
  ...
  - name: 'Huile d''olive vierge extra'
    ...
    optional: false
    notes: ''
  - name: 'Graines de sésame doré'
    quantity: null
    unit: ''
    optional: false
    notes: 'À parsemer au moment du service'
  - name: 'Sel'
    quantity: null
    unit: ''
    optional: false
